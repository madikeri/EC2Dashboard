...
public class TestEc2Fail  {
	...
	public void testListAllEc2()
	  throws Exception {
	    ...
	    // this test is expected to fail because, we are creating only 2 instances
	    // and here we are checking to see if it has the size 6
	    ...
	    System.out.println("Test Failed: " + content);
